        ...
        .directive('mdHoursMinutes', function() {
            ...
            return {
                ...
                template: '<md-input-container md-no-float>' +
                    ...
                    '<span class="md-up-arrow" aria-hidden="true" ng-disabled="readOnly" ng-click="!readOnly && increase()" tabindex="-1"></span>' +
                    '<span class="md-down-arrow" aria-hidden="true" ng-disabled="readOnly" ng-click="!readOnly && decrease()" tabindex="-1"></span>' +
        ...
        .directive('mdTimePicker', function() {
            ...
            return {
                ...
                template: '<ng-form name="timeForm">' +
                    ...
                    '<md-icon md-font-icon="mdi-clock" class="mdi">' +
                    '</md-icon>' +
