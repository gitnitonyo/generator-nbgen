    ...
    function _controllerFn($scope, $element, $attrs) {
        ...
        tmvSelect._constructSelectDom = function() {
            ...
            let selectDom = angular.element('<md-select>')
                ...
                .attr('md-no-asterisk', '')
                .attr('aria-label', tmvSelect.fieldSchema.fieldName);
            ...
            if (tmvSelect.fieldSchema.fieldValidateRulesRequired !== undefined) {
                selectDom.attr('ng-required', tmvSelect.fieldSchema.fieldValidateRulesRequired)
            }
