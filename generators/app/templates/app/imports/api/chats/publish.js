/**
 * Controls published information for Chats collection
 */
import { Chats } from '.';
import { publishCollection } from '../common/publish.js'
import { COLLECTION_PUBLIC_FIELD, COLLECTION_OWNER_FIELD, COLLECTION_GROUP_FIELD, appRoles, getActiveGroup } from '../../common/app.roles'
import { Roles } from '../common';

const publishName = 'chats';
